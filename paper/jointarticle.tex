...
\begin{figure}
    \includegraphics[width=\columnwidth]{New_Framework_with_numbers.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{GaussianMixture_3C_1and2D.png}
...
%&\tilde{\chi}_k = \frac{1}{\lambda_k\cdot\mathop{\hbox{max}} \left({\mitbf{\mu}^{\{k\}}}^2 \right)}. \label{chi_weighting}\\
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{TKC_ChiCurves.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{TKC_Setup_Synthetic.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{TKC_L2_Synthetic.png}
...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{TKC_IndividualPetro_Synthetic.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{TKC_Joint_Synthetic.png}
...
%Considering the confidences $\{\mitbf{\kappa}\}$ as vectors is an important contribution of our framework, and it advances the approach of \citet{Sun2016} for updating the means. In their approach, the updates to the means are controlled per unit only, without differentiating the physical properties that are well-known from the undocumented ones. They can either learn the means of a unit or keep it fixed, whereas the framework I present is capable of learning specific components of the GMM means for each unit, as demonstrated in this example.


\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{TKC_NoPrior3ClustersAssumption_Synthetic.png}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{TKC_LearningGMMmeans.png}
...
\begin{figure}
    \includegraphics[width=\columnwidth]{example_projection.png}
...
\begin{figure*}
    \includegraphics[width=\textwidth]{LinearWithMapping.png}
...
\begin{align}
%&\mathcal{P}(\mitbf{\pi}) = \text{Dir}({\zeta}{\pi}_{\text{prior}}V-1) \label{pi_prior}\\
...
%\begin{align}
%&\mathcal{P}(\mitbf{\mu}| \mitbf{\Sigma}) = \mathcal{N}(\mitbf{\mu}|\mitbf{\mu}_{\text{prior}}, \text{diag}(\mitbf{\kappa}\pi_{\text{prior}}V)^{-1} \Sigma) \label{mu_semiprior} \\
%&\text{and:}\nonumber \\
%&\mathcal{P}(\mitbf{\Sigma}|\mitbf{\mu}) = \mathcal{W}^{-1}(\mitbf{\Sigma}|({\nu}{\pi}_{\text{prior}}V)\mitbf{\Sigma}_{\text{prior}}, {\nu}{\pi}_{\text{prior}}V-q-1) \label{sigma_semiprior}
%\end{align}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{TKC_NoPrior_Synthetic.png}
